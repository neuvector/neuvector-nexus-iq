...
type ClientService interface {
	CreateApplication(params *CreateApplicationParams, authInfo runtime.ClientAuthInfoWriter) (*CreateApplicationOK, error)
...
*/
func (a *Client) CreateApplication(params *CreateApplicationParams, authInfo runtime.ClientAuthInfoWriter) (*CreateApplicationOK, error) {
