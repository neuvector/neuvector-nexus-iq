...
for the set license operation typically these are written to a http.Request
*/
...
// WithFile adds the file to the set license params
func (o *SetLicenseParams) WithFile(file runtime.NamedReadCloser) *SetLicenseParams {
	o.SetFile(file)
	return o
}

// SetFile adds the file to the set license params
func (o *SetLicenseParams) SetFile(file runtime.NamedReadCloser) {
	o.File = file
}
