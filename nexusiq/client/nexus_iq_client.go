...
// NewHTTPClient creates a new nexus iq HTTP client.
func NewHTTPClient(formats strfmt.Registry) *NexusIq {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new nexus iq HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *NexusIq {
...
// New creates a new nexus iq client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *NexusIq {
	// ensure nullable parameters have default
	if formats == nil {
	...
	cli.ThirdPartyScan = third_party_scan.New(transport, formats)
	return cli
}
...
// NexusIq is a client for nexus iq
type NexusIq struct {
	...
	ThirdPartyScan third_party_scan.ClientService

	Transport runtime.ClientTransport
}

// SetTransport changes the transport on the client and all its subresources
func (c *NexusIq) SetTransport(transport runtime.ClientTransport) {
	c.Transport = transport
	c.Application.SetTransport(transport)
	c.License.SetTransport(transport)
	c.Organization.SetTransport(transport)
	c.ThirdPartyScan.SetTransport(transport)
}
