...
// WithOrganizationName adds the organizationName to the get organizations params
func (o *GetOrganizationsParams) WithOrganizationName(organizationName *string) *GetOrganizationsParams {
	o.SetOrganizationName(organizationName)
	return o
}

// SetOrganizationName adds the organizationName to the get organizations params
func (o *GetOrganizationsParams) SetOrganizationName(organizationName *string) {
